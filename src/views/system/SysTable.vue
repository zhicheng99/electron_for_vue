<template>
	<section class="m-t-10">
		...
		<el-row class="m-b-20">
			<el-col :span="24" class="toolbar">
				<el-form :model="filters" :inline="true" ref="filters">
					 <el-form-item label="表名:" :label-width="toolLabelWidth" prop="s_name">
						 <el-input v-model="filters.s_name" placeholder="请输入表名" size="small"></el-input>
					 </el-form-item>  
					 <el-form-item>
					...
					<el-form-item>
						<el-button     @click.native.prevent="dialogAreaAddVisible=true" size="small" icon="el-icon-plus">新增表</el-button>
					</el-form-item> 
					<el-form-item>
						<el-button  :disabled="sels.length==0"   @click.native.prevent="dialogAreaAddVisible=true" size="small" icon="el-icon-download">下载源码</el-button>
					</el-form-item> 
				</el-form>
			</el-col>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading"   style="width: 100%;" @selection-change="handleSelectionChange">
			...
			<el-table-column prop="tableRows" label="数据量" width="120"   >
			</el-table-column>
