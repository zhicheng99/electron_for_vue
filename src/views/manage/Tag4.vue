		...
		<el-table :data="users" highlight-current-row v-loading="listLoading"   style="width: 100%;" >
			...
			<el-table-column label="图标" width="120">
				<template slot-scope="scope">
					<img :src="scope.row.cover" height="50" width="50" alt="">
				</template>
		...
		<el-dialog title="新增标签" :visible.sync="dialogAreaAddVisible">
		 	<el-form :model="addForm" :rules="addFormRules" ref="addForm"> 
		 		...
		 		<el-form-item label="标签图标:" :label-width="formLabelWidth"  prop="cover">
		 			<UploadImg v-if="dialogAreaAddVisible" v-bind:max-num="'1'" v-bind:upload-img.sync="addForm.cover"></UploadImg>
					<div class="tip">
		 		...
		 		<el-form-item label="标签排序:" :label-width="formLabelWidth" prop="sort">
		 			<el-input type="number" max="500" min="0" v-model="addForm.sort" size="small"></el-input>
		 		</el-form-item>
		 ...
		 <el-dialog title="编辑标签" :visible.sync="editFormVisible">
		 	<el-form :model="editForm" :rules="addFormRules" ref="editForm"> 
		 		...
		 		<el-form-item label="标签图标:" :label-width="formLabelWidth"  prop="cover">
		 			<UploadImg v-if="editFormVisible" v-bind:max-num="'1'" v-bind:upload-img.sync="editForm.cover"></UploadImg>
					<div class="tip">
						<i class="el-icon-warning"></i>
						请选择图片上传,支持png,jpg,gif
					</div>
